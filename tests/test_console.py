...
"""
    ...
    def test_help_show(self):
        ...
        s = 'Displays the string representation of an instance\n        \n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_all(self):
        ...
        s = 'Prints a list of all instances using their names only\n        \n'
        self.assertEqual(s, f.getvalue())
